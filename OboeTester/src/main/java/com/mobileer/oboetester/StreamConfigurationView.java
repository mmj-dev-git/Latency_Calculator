...
public class StreamConfigurationView extends LinearLayout {
    ...
    private void initializeViews(Context context) {
        ...
        // Mohsin was here
        if(Constants.LATENCY_MODEL.getVoiceRecLatencyNormal()==0){
//        if (!SharedPref.isVoiceRecLatencyNormalSet(getContext())) {
            mInputPresetSpinner.setSelection(2);
        } else {
            mInputPresetSpinner.setSelection(3);
        }
        // TODO need better way to select voice recording default

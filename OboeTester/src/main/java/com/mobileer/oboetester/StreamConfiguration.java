...
public class StreamConfiguration {
    ...
    public void setChannelConversionAllowed(boolean b) {
        mChannelConversionAllowed = b;
    }
    ...
    public void setRateConversionQuality(int quality) {
        mRateConversionQuality = quality;
    }

...
public class BufferSizeView extends LinearLayout {
    ...
    public void setBufferSizeByNumBursts(int numBursts) {
        int sizeFrames = -1;
        if (mStream != null) {
            int framesPerBurst = mStream.getFramesPerBurst();
            if (framesPerBurst > 0) {
    ...
    public void setBufferSizeByPosition(int progress) {
        int sizeFrames = -1;
    ...
    public void setBufferSize(StringBuffer message, int sizeFrames) {
        if (mStream != null) {
